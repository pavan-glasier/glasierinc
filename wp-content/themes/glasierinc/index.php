		...
		<?php else : ?>
			...
			<section class="inner-wrap">
			    <div class="container">
			        <div class="row">
			            <div class="col-md-12 inner-header">
			                <h1><?php _e( 'No posts to display', 'glasierinc' ); ?></h1>
			            </div>
			        </div>
			    </div>
			</section>
			            ...
			            <div class="row">
			                <div class="col-md-12 text-center">
			                	<div class="site-heading text-center">
				                  <h2><?php _e( 'No posts to display', 'glasierinc' ); ?></h2>
				                  <p><?php
									/* translators: %s: Post editor URL. */
									printf( __( 'Ready to publish your first post? <br/><br/><a href="%s" class="btn btn-theme border btn-md">Get started here</a>.', 'glasierinc' ), admin_url( 'post-new.php' ) );
									?>
								</p>
				               	</div>
			                </div>
			            ...
			            <div class="row">
			                <div class="col-md-12 text-center">
			                	<div class="site-heading text-center">
				                  ...
				                  <p><?php _e( 'Apologies, but no results were found. Perhaps searching will help find a related post.', 'glasierinc' ); ?>
								</p>
				               	</div>
			                </div>
			            </div>
