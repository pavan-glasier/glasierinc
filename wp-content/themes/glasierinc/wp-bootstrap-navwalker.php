...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) :
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = null ) {
			...
			/*
			 * The `.menu-dropdown` container needs to have a labelledby
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			if ( $this->has_children && 0 === $depth ) {
				...
				// For items in dropdowns use .dropdown-item instead of .smooth-menu.
				if ( $depth > 0 ) {
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="megamenu"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="menu-links" title="' . esc_attr__( 'Add a menu', 'wp-bootstrap-navwalker' ) . '">' . esc_html__( 'Add a menu', 'wp-bootstrap-navwalker' ) . '</a></li>';
			$fallback_output .= '</ul>';
