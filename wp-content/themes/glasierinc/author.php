      ...
      <div class="container">
         <div class="row">
            <div class="col-md-12 inner-header">
               <!-- <h1><?php //printf( __( 'Author : %s', 'glasierinc' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' );?></h1> -->

               <!-- <h1><?php //printf( __( 'Author : %s', 'glasierinc' ), '<span class="vcard">' . get_the_author() . '</span>' );?></h1> -->
               ...
               <div class="card">
               		...
               		<div class="details">
               			<h2><?php printf( __( '%s', 'glasierinc' ), '<span class="vcard">' . get_the_author() . '</span>' );?></h2>
